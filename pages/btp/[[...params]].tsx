...
export async function getServerSideProps(context: GetServerSidePropsContext) {
  ...
  if (params !== undefined) {
    if (params[0] == "new") return { props: { new: true } }
      ...
      const btp = await axios.get(`${baseUrl}/${params[1]}`).then(function (res) { return res.data }).catch(function (e) { return {} })
      return { props: { edit: true, btp } }
    }
    else {
      const btp = await axios.get(`${baseUrl}/${params[0] == "edit" ? params[1] : params[0]}`).then(function (res) { return res.data }).catch(function (e) { return {} })
      return { props: { btp } }
    }
      ...
      <div className="card-body">
        {!props.edit && props.btp &&
          <div className='d-flex'>
            {props.btp.fphoto && <Image className="me-3" src={props.btp.fphoto} width={150} height={150} alt={props.btp.nom} />}
            <div>
              <h1>{props.btp.nom}</h1>
