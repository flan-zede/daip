              ...
              <div className="dropdown-menu p-0" aria-labelledby="appsDropdown">
                ...
                <div className="row g-0 p-1">
                  <div className="col-3 text-center">
                    <Link href="#" className="dropdown-item d-flex flex-column align-items-center justify-content-center wd-70 ht-70"><Icon.MessageSquare className="icon-lg mb-1" /><p className="tx-12">Chat</p></Link>
                  </div>
                  <div className="col-3 text-center">
                    <Link href="#" className="dropdown-item d-flex flex-column align-items-center justify-content-center wd-70 ht-70"><Icon.Calendar className="icon-lg mb-1" /><p className="tx-12">Calendar</p></Link>
                  </div>
                  <div className="col-3 text-center">
                    <Link href="#" className="dropdown-item d-flex flex-column align-items-center justify-content-center wd-70 ht-70"><Icon.Mail className="icon-lg mb-1" /><p className="tx-12">Email</p></Link>
                  </div>
                  <div className="col-3 text-center">
                    <Link href="#" className="dropdown-item d-flex flex-column align-items-center justify-content-center wd-70 ht-70"><Icon.Instagram className="icon-lg mb-1" /><p className="tx-12">Profile</p></Link>
                  </div>
                </div>
                <div className="px-3 py-2 d-flex align-items-center justify-content-center border-top"><Link href="#">View all</Link></div>
              </div>
            </li>
            <li className="nav-item dropdown">
              ...
              <div className="dropdown-menu p-0" aria-labelledby="messageDropdown">
                ...
                <div className="p-1">
                  <Link href="#" className="dropdown-item d-flex align-items-center py-2">
                    <div className="me-3">
                      <Image width='30' height='30' className="rounded-circle" src="/image/faces/face2.jpg" alt="user" />
                    </div>
                  ...
                  <Link href="#" className="dropdown-item d-flex align-items-center py-2">
                    <div className="me-3">
                      <Image width='30' height='30' className="rounded-circle" src="/image/faces/face3.jpg" alt="userr" />
                    </div>
                    <div className="d-flex justify-content-between flex-grow-1">
                      <div className="me-4">
                        <p>Carl Henson</p>
                  ...
                  <Link href="#" className="dropdown-item d-flex align-items-center py-2">
                    <div className="me-3">
                      <Image width='30' height='30' className="rounded-circle" src="/image/faces/face4.jpg" alt="userr" />
                    </div>
                    <div className="d-flex justify-content-between flex-grow-1">
                      <div className="me-4">
                        <p>Jensen Combs</p>
                  ...
                  <Link href="#" className="dropdown-item d-flex align-items-center py-2">
                    <div className="me-3">
                      <Image width='30' height='30' className="rounded-circle" src="/image/faces/face5.jpg" alt="userr" />
                    </div>
                    <div className="d-flex justify-content-between flex-grow-1">
                      <div className="me-4">
                        <p>Amiah Burton</p>
                  ...
                  <Link href="#" className="dropdown-item d-flex align-items-center py-2">
                    <div className="me-3">
                      <Image width='30' height='30' className="rounded-circle" src="/image/faces/face6.jpg" alt="userr" />
                    </div>
                    <div className="d-flex justify-content-between flex-grow-1">
                      <div className="me-4">
                        <p>Yaretzi Mayo</p>
            ...
            {session &&
              <li className="nav-item dropdown">
                <Link className="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <Image width='30' height='30' className="rounded-circle" src="/image/faces/face1.jpg" alt="profile" />
                </Link>
